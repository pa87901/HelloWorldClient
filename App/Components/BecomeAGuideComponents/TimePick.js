...
import { becomeGuideFromHour, becomeGuideToHour } from '../../Actions/BecomeAGuideActions.js';
...
class TimePick extends Component {
  ...
  handleFromHourChange(hour) {
    ...
    if (this.props.search.fromHour >= this.props.search.toHour) {
      this.props.dispatch(becomeGuideToHour(fromHour + 1));
    }
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        <Picker
          selectedValue={allHours[this.props.becomeAGuide.fromHour]}
          onValueChange={(hour) => {
        ...
        <Picker
          selectedValue={allHours[this.props.becomeAGuide.toHour]}
